 ...
 *
 * すべて各公式サイトを直接取得して確認した内容。
 * 初出は 2026-09-14、熊本と長崎は 2026-09-15 に取り直して更新した。
...
export const SCHEMES: Scheme[] = [
  ...
  {
    // 2026-09-15 に県公式のお知らせを直接取得して更新。
    // 販売開始は本日10時、準備の整った事業者から順に始まる。
    // 販売チャネルをまとめた特設ページは「9月15日開設予定」で、
    // 9時53分の時点ではまだ公開されていなかったため、リンクはお知らせのままにしてある。
    slug: 'kumamoto-oen',
    pref: '熊本県',
    prefShort: '熊本',
    name: '熊本ふっこう応援割',
    ...
    booking: '2026年9月15日10時から。準備の整った事業者から順に販売',
    status: 'open',
    official: [
      { label: '熊本県公式観光サイト「もっと、もーっと！くまもっと。」', url: 'https://kumamoto.guide/topics/detail/545' },
    ],
    note: 'すでに予約済みの旅行商品は対象外です。予算の上限に達し次第終了と案内されています。'
      + '販売する事業者の一覧は、県公式観光サイト内の特設ページで順次公開されます。',
    applyNote: '販売は事業者ごとに準備が整い次第はじまるため、開始日は取扱先によって違います。'
      + '利用者向けの問い合わせ窓口（0800-111-9449／9時30分〜17時30分）は9月15日から受付を開始しています。'
      + 'ただし宿泊の予約そのものは受け付けていません。',
  },
  {
    slug: 'saga-oen',
    pref: '佐賀県',
  ...
  {
    // 2026-09-15 に「ながさき旅ネット」を直接取得して更新。
    // 前回は「9月第3週をめど」で日付が確定していなかったが、先行予約販売の開始が
    // 9月15日10時と公表された。取扱先ごとに開始日が違うので、それも本文に持たせる。
    slug: 'nagasaki-oen',
    pref: '長崎県',
    prefShort: '長崎',
    name: '『九州ふっこう応援割』ながさきキャンペーン',
    parent: '九州ふっこう応援割',
    period: '2026年10月1日チェックイン〜12月1日チェックアウト（先行販売分）',
    booking: '2026年9月15日10時から、じゃらんnetと楽天トラベルで先行販売',
    status: 'open',
    official: [
      { label: '長崎県観光連盟「ながさき旅ネット」', url: 'https://www.nagasaki-tabinet.com/feature/ouenwari' },
    ],
    note: '予約販売期間は2026年9月15日10時から11月29日23時59分まで。予算の上限に達した時点で終了します。'
      + '12月1日以降の宿泊分の予約販売開始は、あらためて案内されます。'
      + 'すでにしてある予約は対象外で、対象になるのは各取扱先の予約開始日以降の申し込みです。',
    applyNote: '取扱先によって予約開始日が違います。じゃらんnetと楽天トラベルは9月15日10時から、'
      + '割引対象の宿泊施設への直接予約は9月28日から、そのほかの旅行会社・OTAは9月30日から、'
      + 'それぞれ準備が整い次第はじまります。参画事業者の募集とキャンペーン特設サイトの公開は9月18日の予定です。',
  },
  {
    slug: 'oita-oen',
    pref: '大分県',
